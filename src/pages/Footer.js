            ...
            <div className="row">
              <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div className="recent-post widghet">
                  ...
                  <div className="post-list">
                    <figure>
                      <img src="assets/images/collections/4.jpg" alt="" />
                    </figure>
                    <div className="content">
                      <h5>
                        <Link to={"/"}>This is Photoshop's version of lorem</Link>
                      </h5>
              ...
              <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div className="products-deal widghet">
                  ...
                  <div className="product-lists">
                    <figure>
                      <img src="assets/images/collections/5.jpg" alt="" />
                    </figure>
                    <div className="content">
                      <h5>
                        <Link to={"/"}>This is Photoshop's version of lorem</Link>
              ...
              <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div className="products-deal widghet">
                  ...
                  <div className="product-lists">
                    ...
                    <div className="content">
                      <h5>
                        <a href="#">This is Photoshop's version of lorem</a>
                      </h5>
                      <span>$32</span>
                    </div>
                  </div>
            ...
            <div className="container">
              <div className="row">
                <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <div
                    className="subs-form wow animated fadeInDown"
                    data-wow-duration="1.5s"
                  >
                    <form>
                      <input type="email" placeholder="Enter Your Email" />
                      <button type="submit">
                        Subscribe <i className="fa fa-send"></i>
                      </button>
                    </form>
                  </div>
                </div>
                  ...
                  <div className="footer-content">
                    ...
                    <ul className="list-inline foo-con-info">
                      <li>
                        ...
                        <span>Uk Street, Green Home City, London.</span>
                      </li>
                      <li>
              ...
              <div className="row">
                <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <div className="copyright">
                    <p>
                      Webstrot © 2018 Powered by Theshop™. All Rights Reserved
                    </p>
                  </div>
                </div>
              </div>
