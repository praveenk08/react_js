                ...
                <div className="col-lg-6 col-md-6 col-sm-4 col-xs-12 hidden-sm hidden-xs">
                  <div className="info-top">
                    <ul className="list-inline">
                      ...
                      <li>
                        <i className="fa fa-phone"></i>Call support free :
                        <span>+1800 12345 67890</span>
                      </li>
                    </ul>
                  </div>
                </div>
                <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                  <div className="topber-link text-right">
                    <ul className="list-inline">
                      ...
                      <li>
                        <Link to={"/"} className="cart-btns">
                          <i className="fa fa-shopping-cart"></i>My Cart (0)
                        </Link>
                      </li>
                    </ul>
                  </div>
          ...
          <div className="offset-area">
            <div className="offset-cart-area offset-body">
              <div className="offset-heading">
                <h3>Cart lists</h3>
                <i className="close-offset flaticon-letter-x"></i>
              </div>
              <div className="cart-list">
                    ...
                    <tr>
                      ...
                      <td>
                        <span className="close">
                          <i className="flaticon-letter-x"></i>
                        </span>
                      </td>
                    </tr>
                    <tr>
                ...
                <Link to={"/"} className="btn1 floatright mr-t25">
                  checkout
                </Link>
              </div>
            </div>
